...
COPP_API_BASE_URL='https://coppapi.copp.knotta.ru/api/v1'
COPP_API_REFRESH_TOKEN='eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ0b2tlbl90eXBlIjoicmVmcmVzaCIsImV4cCI6MTY0ODY0ODI1OSwianRpIjoiNzgwYzc4MGExZGI4NDExZjgyZmNhYWE0NzhhNDkwMzQiLCJ1c2VyX2lkIjoiOWJiMTZmMDgtNmUyZi00MmM4LTk4YTMtNjBkNGUxNGU5NmZhIn0.mCh7jQyVvkDp7ReM9get3vD8Bj2sGZiJa3Tnkc-5DBc'

SOCIAL_AUTH_EDX_OAUTH2_URL_ROOT = "http://edx.devstack.lms:18000"
BACKEND_SERVICE_EDX_OAUTH2_KEY = "studio-backend-service-key"
BACKEND_SERVICE_EDX_OAUTH2_SECRET = "studio-backend-service-secret"
DISCOVERY_COURSES_ENDPOINT = "http://edx.devstack.discovery:18381/api/v1"
